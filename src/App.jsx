// ============================================================
// Marie Gluesenkamp Perez Dashboard — App.jsx
...
const DATA = {
  ...
  finances: {
    totalRaised: 344126.52,
    emailDigital: 8053.5,
    smsDigital: 20.0,
    digitalTarget: 0.10,
    byMonth: [
      { month: "2025-11", total: 39099.31, digital: 1648.5 },
      { month: "2025-12", total: 69391.33, digital: 1663.5 },
      { month: "2026-01", total: 48476.16, digital: 1614.5 },
      { month: "2026-02", total: 80462.65, digital: 1398.5 },
      { month: "2026-03", total: 98905.86, digital: 1553.5 },
      { month: "2026-04", total: 7791.21, digital: 195.0 }
    ],
  },

  texting: {
    campaigns: [
      { name: "November 2025 EOM_1", date: "11/25/25", delivered: 5430, clicked: 94, revenue: 0 },
      { name: "November 2025 EOM_2", date: "11/25/25", delivered: 5227, clicked: 111, revenue: 0 },
      { name: "EOQ4 251229", date: "12/29/25", delivered: 3979, clicked: 95, revenue: 0 },
      { name: "EOQ4 251231", date: "12/31/25", delivered: 5430, clicked: 148, revenue: 0 },
      { name: "EOM_Jan26_1", date: "2/27/26", delivered: 1370, clicked: 33, revenue: 0 },
      { name: "EOQ-March2026-1", date: "3/26/26", delivered: 2024, clicked: 34, revenue: 0 },
      { name: "EOQ-March2026-2", date: "3/26/26", delivered: 1253, clicked: 23, revenue: 0 },
      { name: "EOQ-March2026-3", date: "3/26/26", delivered: 3425, clicked: 79, revenue: 0 },
      { name: "EOQ_March2026_HD_Test", date: "3/27/26", delivered: 27, clicked: 2, revenue: 0 }
    ],
    costPerMsg: 0.07,
  },
  ...
  return (
    <div style={{ fontFamily:"Arial,sans-serif", maxWidth:1100, margin:"0 auto", padding:20 }}>
      <h1 style={{ background:"#1F4E79", color:"#fff", padding:"12px 20px", borderRadius:6, marginBottom:16 }}>
        Marie Gluesenkamp Perez — Digital Dashboard ({DATA.period})
      </h1>
